...
#  Be sure to run `pod spec lint id.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Skymavis" => "https://github.com/skymavis"}
  # Or just: spec.author    = "thienNH0"
  # spec.authors            = { "thienNH0" => "thien.hoang.nguyen@skymavis.com" }
  # spec.social_media_url   = "https://twitter.com/thienNH0"
